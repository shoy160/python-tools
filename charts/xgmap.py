...
def getChinaData():
    url = 'https://view.inews.qq.com/g2/getOnsInfo?name=disease_h5&_=' + \
        str(time.time())
...
def render():
    ...
    map = Map(options.InitOpts(bg_color="#87CEFA",
                               width="100%", height="900px", page_title='世界疫情分布'))
    for item in maps:
        map_data = {}
        ...
        map.add(series_name=maps[item],  # 名称
